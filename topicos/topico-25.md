...
Criar uma _issue_ no projeto https://github.com/plinioleitao/bd-2021-1-bgi, com o título "Tópico 25", para responder: 
...
1. _Issue_ criada no projeto https://github.com/plinioleitao/bd-2021-1-bgi, cujo título é "Tópico 25", para indicar suas reflexões iniciais sobre *decisões de projeto no Modelo Entidade Relacionamento (MER)*.
