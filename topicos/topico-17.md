...
Criar uma _issue_ no projeto https://github.com/plinioleitao/bd-2021-1-bgi, com o título "Tópico 17", para responder: 
...
&nbsp;&nbsp;&nbsp;&nbsp;(C3) SELECT * FROM R WHERE (at2=at2) OR (NOT at3=at3)<br>
...
1. _Issue_ criada no projeto https://github.com/plinioleitao/bd-2021-1-bgi, cujo título é "Tópico 17", para entender e usar Junção e Valores Nulos em consultas da SQL.
