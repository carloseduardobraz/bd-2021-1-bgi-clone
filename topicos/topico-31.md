...
|Esquema de relação|
|-|
|PESSOAJURIDICA (CodPes, Fone, CGC, RazaoSocial, NomeFantasia)<br>PESSOAJURIDICA (CodCli) IS PRIMARY KEY|
|PESSOAFISICA (CodPes, Fone, CPF, Nome, DataNasc, Sexo)<br>PESSOAFISICA (CodCli) IS PRIMARY KEY|
...
|Esquema de relação|
|-|
|PESSOA (CodPes, **Tipo**, Fone, CGC, RazaoSocial, NomeFantasia, CPF, Nome, DataNasc, Sexo)<br>PESSOA (CodCli) IS PRIMARY KEY|
...
Crie o diretório **topico-31** no seu repositório https://github.com/nomealuno/bd-2021-1-bgi, onde **nomealuno** é o nome da conta do aluno no Github. Este é o repositório que você criou no início da disciplina.
